...
| C3-03 | [#25](https://github.com/TheHighBrid/Agents-Gang/issues/25) | P1 | Chapter 3 - Governed Integration Fabric | Manus Agent | C1-05 | Review | Calendar read/prepare/mutate policy and idempotency tests pass. |
