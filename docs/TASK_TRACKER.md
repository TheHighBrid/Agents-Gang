...
| C1-05 | [#17](https://github.com/TheHighBrid/Agents-Gang/issues/17) | P0 | Chapter 1 — Approval Control Plane | Manus Agent | C1-01 | Review | Typed policy registry covers every enabled tool/action. |
| C1-06 | [#18](https://github.com/TheHighBrid/Agents-Gang/issues/18) | P0 | Chapter 1 — Approval Control Plane | Codex | C1-03, C1-04, C1-05 | Review | Threat model and abuse regressions are reviewed and green. |
| C2-01 | [#19](https://github.com/TheHighBrid/Agents-Gang/issues/19) | P0 | Chapter 2 — Founder Operations Surface | SOL 5.6 | C1-03 | Review | Accessible approval queue/detail UI reads protected persisted data. |
...
| C2-03 | [#21](https://github.com/TheHighBrid/Agents-Gang/issues/21) | P1 | Chapter 2 — Founder Operations Surface | SOL 5.6 | C1-02 | Review | Persisted run/route/tool/audit dashboard with all state handling. |
...
| C3-01 | [#23](https://github.com/TheHighBrid/Agents-Gang/issues/23) | P0 | Chapter 3 — Governed Integration Fabric | Manus Agent | C1-05 | Review | Shopify test-store contract, policy gates, and failure behavior verified. |
| C3-02 | [#24](https://github.com/TheHighBrid/Agents-Gang/issues/24) | P1 | Chapter 3 — Governed Integration Fabric | Manus Agent | C1-05 | Review | Gmail read/draft/send policy contract and audit tests pass. |
...
| C4-01 | [#28](https://github.com/TheHighBrid/Agents-Gang/issues/28) | P0 | Chapter 4 — Scheduling and Observability | Manus Agent | C3-05 | In progress | Scheduler supports idempotency, retry taxonomy, concurrency, durable state. |
