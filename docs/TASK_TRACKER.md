...
|---|---:|---|---|---|---|---|---|
| C0-01 | [#10](https://github.com/TheHighBrid/Agents-Gang/issues/10) | P0 | Chapter 0 — Program Control | Codex | — | Accepted | Full CI quality gate green on push and pull request; merged through PR #44. |
| C0-02 | [#11](https://github.com/TheHighBrid/Agents-Gang/issues/11) | P0 | Chapter 0 — Program Control | Manus Agent | — | Accepted | Labels, milestones, issue workflow, and planning references published; merged planning blueprint is present on main. |
| C0-03 | [#12](https://github.com/TheHighBrid/Agents-Gang/issues/12) | P1 | Chapter 0 — Program Control | SOL 5.6 | C0-02 | Accepted | Release evidence register and decision-log convention documented; merged through PR #41. |
| C1-01 | [#13](https://github.com/TheHighBrid/Agents-Gang/issues/13) | P0 | Chapter 1 — Approval Control Plane | Codex | C0-01 | Accepted | Anonymous/non-founder/founder authorization test matrix passes; merged through PR #42/#44. |
| C1-02 | [#14](https://github.com/TheHighBrid/Agents-Gang/issues/14) | P0 | Chapter 1 — Approval Control Plane | Codex | C1-01 | Accepted | Safe paginated approval repository queries and indexes verified; hardened in merged PR #46. |
| C1-03 | [#15](https://github.com/TheHighBrid/Agents-Gang/issues/15) | P0 | Chapter 1 — Approval Control Plane | Codex | C1-01, C1-02 | Accepted | Protected list/detail API contract and redaction tests pass; merged through PR #44/#46. |
| C1-04 | [#16](https://github.com/TheHighBrid/Agents-Gang/issues/16) | P0 | Chapter 1 — Approval Control Plane | Codex | C1-01, C1-02 | Accepted | Atomic pending-only approve/reject behavior and audit tests pass; merged through PR #44. |
| C1-05 | [#17](https://github.com/TheHighBrid/Agents-Gang/issues/17) | P0 | Chapter 1 — Approval Control Plane | Manus Agent | C1-01 | Review | Typed policy registry covers every enabled tool/action; 16-tool inventory, metadata-drift checks, and defineTool enforcement pass locally. |
| C1-06 | [#18](https://github.com/TheHighBrid/Agents-Gang/issues/18) | P0 | Chapter 1 — Approval Control Plane | Codex | C1-03, C1-04, C1-05 | Accepted | Threat model and abuse regressions are reviewed and green; merged through PR #44. |
| C2-01 | [#19](https://github.com/TheHighBrid/Agents-Gang/issues/19) | P0 | Chapter 2 — Founder Operations Surface | SOL 5.6 | C1-03 | Accepted | Accessible approval queue/detail UI reads protected persisted data; merged through PR #45. |
...
| C3-01 | [#23](https://github.com/TheHighBrid/Agents-Gang/issues/23) | P0 | Chapter 3 — Governed Integration Fabric | Manus Agent | C1-05 | Unblocked | Shopify test-store contract, policy gates, and failure behavior verified. C1-05 policy dependency is now implemented on branch agent/17-capability-risk-policy. |
...
| C3-05 | [#27](https://github.com/TheHighBrid/Agents-Gang/issues/27) | P0 | Chapter 3 — Governed Integration Fabric | Manus Agent | C3-01–C3-04 as applicable | Accepted | All currently enabled scheduled audits use the shared governed execution contract; merged through PR #43. |
