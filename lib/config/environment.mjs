...
const optionalFeatures = ["ai", "shopify", "gmail", "web_search", "inbox_alerts"];
...
function validateCore(errors, environment, target) {
  ...
  // Staging dashboard reads use the founder-authenticated Edge Function bridge;
  // the service-role credential stays in Supabase instead of the web runtime.
