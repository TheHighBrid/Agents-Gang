...
describe("deployment environment validation", () => {
  ...
  test("requires core governance configuration in staging and production", () => {
    const result = validateDeploymentEnvironment(base({ SUPABASE_SERVICE_ROLE_KEY: undefined }));
